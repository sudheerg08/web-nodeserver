...
var server = http.createServer(function (req, res) {
    if (req.url == '/') {
        ...
        res.write('<html><body><p>This is the Default Page of the Server and its working fine. If You have not specified anything or a Address, this page should be visible. Final changes on 09/28, but they are seen!!</p></body></html>');
        res.end();
